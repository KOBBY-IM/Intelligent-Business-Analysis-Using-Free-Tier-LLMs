...
def test_statistical_analysis():
    ...
    print(
        f"✅ Descriptive stats: Mean={desc_stats['mean']:.4f}, Std={desc_stats['std']:.4f}"
    )
    ...
    # Test rankings
    results = {"Provider_A": group1, "Provider_B": group2, "Provider_C": group3}
...
def test_batch_evaluation():
    ...
    try:
        ...
        print(
            f"⚠️ Batch evaluation test failed (expected if APIs are not configured): {e}"
        )
