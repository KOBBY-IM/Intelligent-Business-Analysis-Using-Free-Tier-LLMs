...
class FAISSVectorStore:
    ...
    def __init__(self, 
        ...
        logger.info(f"Initialized FAISS vector store with embedding dimension: {self.embedding_dim}")
    
    def _create_chunks(self, text: str, source_document: str, metadata: Dict[str, Any] = None) -> List[DocumentChunk]:
        """
    ...
    def load(self, directory: str):
        ...
        logger.info(f"Loaded vector store from {directory} with {len(self.chunks)} chunks")
