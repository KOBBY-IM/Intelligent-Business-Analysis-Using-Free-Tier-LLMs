...
class RAGPipeline:
    ...
    def __init__(self, 
        ...
        logger.info(f"Initialized RAG pipeline with top_k={top_k}, max_context_length={max_context_length}")
    ...
    def query(self, 
        ...
        context = self.retriever.format_context(retrieval_result, self.max_context_length)
        ...
        pipeline_metrics = {
            ...
            "retrieval_quality": self.retriever.analyze_retrieval_quality(retrieval_result),
        ...
        result = RAGResult(
            query=query,
            response=llm_response.text if llm_response.success else f"Error: {llm_response.error}",
        ...
        logger.info(f"RAG pipeline completed in {total_time:.2f}ms - "
    ...
    def batch_query(self, 
                   ...
                   max_tokens: int = 500,
                   temperature: float = 0.7,
                   model: Optional[str] = None) -> List[RAGResult]:
        """
    ...
    def test_pipeline(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "test_response": result.response[:100] + "..." if len(result.response) > 100 else result.response
            }
        except Exception as e:
