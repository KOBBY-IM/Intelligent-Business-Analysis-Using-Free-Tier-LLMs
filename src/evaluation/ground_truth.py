...
class GroundTruthManager:
    ...
    def load_ground_truth(self):
        ...
        try:
            if self.ground_truth_file.exists():
                data = load_json_file(self.ground_truth_file)
                for answer_data in data.get("answers", []):
                    self.answers[answer_data["question_id"]] = answer_data
        ...
        default_answers = [
            {
                ...
                "domain": "retail",
                "metadata": {
                    "data_source": "shopping_trends.csv",
            ...
            },
            {
                ...
                "domain": "finance",
                "metadata": {
                    "data_source": "financial_reports.csv",
            ...
            },
            {
                ...
                "domain": "healthcare",
                "metadata": {
                    "data_source": "patient_surveys.csv",
                    "analysis_type": "satisfaction_analysis",
                },
            },
        ]
    ...
    def save_ground_truth(self):
        ...
        try:
            ...
            logger.info(
                f"Saved {len(self.answers)} ground truth answers to {self.ground_truth_file}"
            )
    ...
    def get_answers_by_category(self, category: str) -> List[GroundTruthAnswer]:
        ...
        return [
            answer for answer in self.answers.values() if answer.category == category
        ]
    ...
    def search_questions(self, query: str) -> List[GroundTruthAnswer]:
        ...
        for answer in self.answers.values():
            if (
                query_lower in answer.question.lower()
                or query_lower in answer.category.lower()
                or query_lower in answer.domain.lower()
            ):
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_answer_length": sum(
                len(answer.answer) for answer in self.answers.values()
            )
            / len(self.answers),
        }
